# IPOO TP 2 ENTREGABLE Fecha de cierre 18/04/23

Esta rama corresponde a la entrega número 2 del TP obligatorio de IPOO.
Este TPO extiende el trabajo realizado para la entrega N°.1 añadiendo el concepto de delegación.
